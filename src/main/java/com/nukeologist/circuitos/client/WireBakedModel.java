...
public class WireBakedModel implements IBakedModel {

    public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(Reference.MOD_ID + ":wiremodel");

    private TextureAtlasSprite sprite;
    private VertexFormat format;

    public WireBakedModel(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        this.format = format;
        sprite = bakedTextureGetter.apply(new ResourceLocation(Reference.MOD_ID, "blocks/basicwire")); //in-game block sprite
    }
    ...
    public List<BakedQuad> getQuads(@Nullable IBlockState state, @Nullable EnumFacing side, long rand) {
        ...
        Boolean north = extendedBlockState.getValue(BlockBasicWire.NORTH);
        Boolean south = extendedBlockState.getValue(BlockBasicWire.SOUTH);
        Boolean west = extendedBlockState.getValue(BlockBasicWire.WEST);
        Boolean east = extendedBlockState.getValue(BlockBasicWire.EAST);
        Boolean up = extendedBlockState.getValue(BlockBasicWire.UP);
        Boolean down = extendedBlockState.getValue(BlockBasicWire.DOWN);
