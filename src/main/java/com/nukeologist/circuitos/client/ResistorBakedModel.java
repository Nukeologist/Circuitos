package com.nukeologist.circuitos.client;
...
public class ResistorBakedModel implements IBakedModel {

    private TextureAtlasSprite sprite;
    private VertexFormat format;

    public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(Reference.MOD_ID + ":resistormodel");


    public ResistorBakedModel(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        this.format = format;
        sprite = bakedTextureGetter.apply(new ResourceLocation(Reference.MOD_ID, "blocks/basicresistor"));
    }
    ...
    public List<BakedQuad> getQuads(@Nullable IBlockState state, @Nullable EnumFacing side, long rand) {
        ...
        Boolean north = extendedBlockState.getValue(BlockBasicResistor.NORTH);
        Boolean south = extendedBlockState.getValue(BlockBasicResistor.SOUTH);
        Boolean west = extendedBlockState.getValue(BlockBasicResistor.WEST);
        Boolean east = extendedBlockState.getValue(BlockBasicResistor.EAST);
        ...
        if (down) {
            ...
            quads.add(createQuad(new Vec3d(o, 0, o), new Vec3d(1 - o, 0, o), new Vec3d(1 - o, 0, 1 - o), new Vec3d(o, 0, 1 - o), sprite));
        } else {
        ...
        if (east) {
            ...
            quads.add(createQuad(new Vec3d(1, o, o), new Vec3d(1, 1 - o, o), new Vec3d(1, 1 - o, 1 - o), new Vec3d(1, o, 1 - o), sprite));
        } else {
        ...
        if (west) {
            ...
            quads.add(createQuad(new Vec3d(0, o, 1 - o), new Vec3d(0, 1 - o, 1 - o), new Vec3d(0, 1 - o, o), new Vec3d(0, o, o), sprite));
        } else {
        ...
        if (north) {
            ...
            quads.add(createQuad(new Vec3d(o, 1 - o, 0), new Vec3d(1 - o, 1 - o, 0), new Vec3d(1 - o, o, 0), new Vec3d(o, o, 0), sprite));
        } else {
        ...
        if (south) {
            ...
            quads.add(createQuad(new Vec3d(o, o, 1), new Vec3d(1 - o, o, 1), new Vec3d(1 - o, 1 - o, 1), new Vec3d(o, 1 - o, 1), sprite));
        } else {
